...
#include "modules/ESKF/nav_state.hpp"
...
namespace Odometry
{
    ...
    public:
        ...
        struct Options
        {
            ...
            double gnss_ang_noise_ = 1.0 * M_PI / 180.0; // GNSS旋转噪声
         ...
         * @return
         */
        bool ObserveSE3(const SE3 &pose, double trans_noise = 0.1, double ang_noise = 1.0 * M_PI / 180.0);
